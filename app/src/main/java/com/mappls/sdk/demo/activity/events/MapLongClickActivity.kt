...
class MapLongClickActivity : AppCompatActivity(), OnMapReadyCallback, MapplsMap.OnMapLongClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding.baseMapHeader.headerTitle.setText(getString(R.string.map_long_tap_title))
