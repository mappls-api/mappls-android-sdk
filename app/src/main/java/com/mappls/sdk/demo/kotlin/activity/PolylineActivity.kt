...
import com.mappls.sdk.demo.databinding.ActivityPolylineBinding
...
class PolylineActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(mapplsMap: MapplsMap) {
        ...
        mBinding.btnAddPolyline.setOnClickListener(View.OnClickListener {
            polyLine =   mapplsMap.addPolyline(PolylineOptions().addAll(listOfLatlang).color(Color.parseColor("#3bb2d0")).width(4f))
