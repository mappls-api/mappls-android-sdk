...
class MapplsPinCameraActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding.tvCameraMove.setOnClickListener {
            mMapplsMap?.moveCamera(CameraMapplsPinUpdateFactory.newMapplsPinZoom("utga9e", 16.0))
        }
        mBinding.tvCameraEase.setOnClickListener {
            mMapplsMap?.easeCamera(CameraMapplsPinUpdateFactory.newMapplsPinZoom("12af19", 16.0), 8000)
        }
        mBinding.tvCameraAnimate.setOnClickListener {
            mMapplsMap?.animateCamera(CameraMapplsPinUpdateFactory.newMapplsPinZoom("3lgk1a", 16.0), 8000)
        }
    }
