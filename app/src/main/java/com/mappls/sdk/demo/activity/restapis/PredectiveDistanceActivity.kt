...
import com.mappls.sdk.demo.settings.fragment.PredectiveDistanceSettingsFragment
...
class PredectiveDistanceActivity : AppCompatActivity(), OnMapReadyCallback, TabLayout.OnTabSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding.directionsPredictiveHeader.headerTitle.text = "Get Predective Distance"
        ...
        mBinding.directionsPredictiveHeader.ivSettings.setOnClickListener {
            val fragment = PredectiveDistanceSettingsFragment()
    ...
    private fun callDistance() {
        ...
        val builder = MapplsDistanceMatrix.builder()
            .profile(mProfile)
            .resource(DirectionsCriteria.RESOURCE_DISTANCE_PREDICTIVE)

        val origin = MapplsPredectiveDistanceApiSettings.instance.origin
        val destination = MapplsPredectiveDistanceApiSettings.instance.destination
        val waypoints = MapplsPredectiveDistanceApiSettings.instance.wayPoints
        ...
        if(MapplsPredectiveDistanceApiSettings.instance.isCurrentTime) {
            ...
            if(MapplsPredectiveDistanceApiSettings.instance.specifiedTime != null && MapplsPredectiveDistanceApiSettings.instance.specifiedTime!! > System.currentTimeMillis()) {
                time = MapplsPredectiveDistanceApiSettings.instance.specifiedTime!!
            }
            builder.dateTime(MapplsDirectionDateTimeSpecified(MapplsPredectiveDistanceApiSettings.instance.locationType,
                time))
        }
        ...
        mDistanceManager?.call(object: OnResponseCallback<DistanceResponse> {
            ...
            override fun onError(p0: Int, p1: String?) {
                if(p0 != ErrorCodes.CANCEL_CALL) {
                    Toast.makeText(this@PredectiveDistanceActivity, "$p0 --- $p1", Toast.LENGTH_SHORT)
                        .show()
                }
            }
