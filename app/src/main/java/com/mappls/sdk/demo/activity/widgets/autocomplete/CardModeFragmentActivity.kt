...
class CardModeFragmentActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding.cardFragmentHeader.headerTitle.text = "Card Mode Fragment"
...
// Conditionally add nullable properties
            ...
            options.build(PlaceOptions.MODE_CARDS)
    ...
    fun replaceFragment(fragment: Fragment, addToBackStack: Boolean = true) {
        ...
        ft.replace(mBinding.autocompleteFragment.id, fragment, fragment.javaClass.simpleName)
