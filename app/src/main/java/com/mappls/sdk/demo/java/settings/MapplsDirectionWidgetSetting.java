...
public class MapplsDirectionWidgetSetting {
    private static final MapplsDirectionWidgetSetting INSTANCE= new MapplsDirectionWidgetSetting();

    public static MapplsDirectionWidgetSetting getInstance() {
        return INSTANCE;
    }
