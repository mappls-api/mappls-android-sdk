...
class PlaceClickActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding.baseMapHeader.headerTitle.setText(R.string.place_click_title)
    ...
    override fun onMapReady(mapplsMap: MapplsMap) {
        ...
        mapplsMap.moveCamera(CameraUpdateFactory.newLatLngZoom(LatLng(
            22.553147478403194,
            77.23388671875), 4.0))
        this.mMapplsMap?.setOnPlaceClickListener { mapplsPin ->
            mapplsPin?.let {
                Toast.makeText(this, "Mappls Pin:: $it", Toast.LENGTH_SHORT).show()
            }
            return@setOnPlaceClickListener true
        }
    }
