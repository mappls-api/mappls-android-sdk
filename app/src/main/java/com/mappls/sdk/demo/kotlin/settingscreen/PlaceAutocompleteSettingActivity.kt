...
class PlaceAutocompleteSettingActivity : AppCompatActivity() {
    ...
    private fun initCallback() {
        ...
        mBinding.rgHorizontal.setOnCheckedChangeListener(RadioGroup.OnCheckedChangeListener { group, checkedId ->
            when (checkedId) {
                R.id.rb_left -> MapplsPlaceWidgetSetting.instance.signatureHorizontal = PlaceOptions.GRAVITY_LEFT
                R.id.rb_center -> MapplsPlaceWidgetSetting.instance.signatureHorizontal = PlaceOptions.GRAVITY_CENTER
                R.id.rb_right -> MapplsPlaceWidgetSetting.instance.signatureHorizontal = PlaceOptions.GRAVITY_RIGHT
            }
        })
        mBinding.rgLogoSize.setOnCheckedChangeListener(RadioGroup.OnCheckedChangeListener { group, checkedId ->
            when (checkedId) {
                R.id.rb_small -> MapplsPlaceWidgetSetting.instance.logoSize = PlaceOptions.SIZE_SMALL
                R.id.rb_medium -> MapplsPlaceWidgetSetting.instance.logoSize = PlaceOptions.SIZE_MEDIUM
                R.id.rb_large -> MapplsPlaceWidgetSetting.instance.logoSize = PlaceOptions.SIZE_LARGE
            }
        })
        mBinding.btnSaveLocation.setOnClickListener(View.OnClickListener {
            if (!TextUtils.isEmpty(mBinding.etLatitude.getText().toString().trim()) && !TextUtils.isEmpty(mBinding.etLongitude.getText().toString().trim())) {
                MapplsPlaceWidgetSetting.instance.location = Point.fromLngLat(mBinding.etLongitude.getText().toString().trim().toDouble(), mBinding.etLatitude.getText().toString().trim().toDouble())
            } else {
        ...
        mBinding.btnSaveFilter.setOnClickListener(View.OnClickListener {
            if (!TextUtils.isEmpty(mBinding.etFilter.getText().toString().trim())) {
                MapplsPlaceWidgetSetting.instance.filter = mBinding.etFilter.getText().toString().trim()
            } else {
        ...
        mBinding.rgPod.setOnCheckedChangeListener(RadioGroup.OnCheckedChangeListener { group, checkedId ->
            when (checkedId) {
                ...
                R.id.rb_state -> MapplsPlaceWidgetSetting.instance.pod = AutoSuggestCriteria.POD_STATE
                R.id.rb_sub_district -> MapplsPlaceWidgetSetting.instance.pod = AutoSuggestCriteria.POD_SUB_DISTRICT
                R.id.rb_district -> MapplsPlaceWidgetSetting.instance.pod = AutoSuggestCriteria.POD_DISTRICT
                R.id.rb_sub_locality -> MapplsPlaceWidgetSetting.instance.pod = AutoSuggestCriteria.POD_SUB_LOCALITY
                R.id.rb_sub_sub_locality -> MapplsPlaceWidgetSetting.instance.pod = AutoSuggestCriteria.POD_SUB_SUB_LOCALITY
                R.id.rb_locality -> MapplsPlaceWidgetSetting.instance.pod = AutoSuggestCriteria.POD_LOCALITY
                R.id.rb_village -> MapplsPlaceWidgetSetting.instance.pod = AutoSuggestCriteria.POD_VILLAGE
        ...
        mBinding.cbEnableTextSearch.setOnCheckedChangeListener(CompoundButton.OnCheckedChangeListener { buttonView, isChecked -> MapplsPlaceWidgetSetting.instance.isEnableTextSearch = isChecked })

        mBinding.backgroundRG.setOnCheckedChangeListener { group, checkedId ->
            when (checkedId) {
                R.id.rb_white -> MapplsPlaceWidgetSetting.instance.backgroundColor = android.R.color.white
                R.id.rb_black -> MapplsPlaceWidgetSetting.instance.backgroundColor = android.R.color.black
                R.id.rb_red -> MapplsPlaceWidgetSetting.instance.backgroundColor = android.R.color.holo_red_light
                R.id.rb_green -> MapplsPlaceWidgetSetting.instance.backgroundColor = android.R.color.holo_green_dark
                R.id.rb_blue -> MapplsPlaceWidgetSetting.instance.backgroundColor = android.R.color.holo_blue_bright
            }
        }
        mBinding.toolbarRG.setOnCheckedChangeListener { group, checkedId ->
            when (checkedId) {
                R.id.rb_white_toolbar -> MapplsPlaceWidgetSetting.instance.toolbarColor = android.R.color.white
                R.id.rb_black_toolbar -> MapplsPlaceWidgetSetting.instance.toolbarColor = android.R.color.black
                R.id.rb_red_toolbar -> MapplsPlaceWidgetSetting.instance.toolbarColor = android.R.color.holo_red_light
                R.id.rb_green_toolbar -> MapplsPlaceWidgetSetting.instance.toolbarColor = android.R.color.holo_green_dark
                R.id.rb_blue_toolbar -> MapplsPlaceWidgetSetting.instance.toolbarColor = android.R.color.holo_blue_bright
            }
        }
    ...
    private fun initSettings() {
        ...
        if ( MapplsPlaceWidgetSetting.instance.location != null) {
            mBinding.etLatitude.setText(MapplsPlaceWidgetSetting.instance.location?.latitude().toString())
            mBinding.etLongitude.setText(MapplsPlaceWidgetSetting.instance.location?.longitude().toString())
        }
        ...
        if ( MapplsPlaceWidgetSetting.instance.pod != null) {
            if ( MapplsPlaceWidgetSetting.instance.pod.equals(AutoSuggestCriteria.POD_CITY, ignoreCase = true)) {
                mBinding.rgPod.check(mBinding.rbCity.getId())
            } else if ( MapplsPlaceWidgetSetting.instance.pod.equals(AutoSuggestCriteria.POD_DISTRICT, ignoreCase = true)) {
                mBinding.rgPod.check(mBinding.rbDistrict.getId())
            } else if ( MapplsPlaceWidgetSetting.instance.pod.equals(AutoSuggestCriteria.POD_LOCALITY, ignoreCase = true)) {
                mBinding.rgPod.check(mBinding.rbLocality.getId())
            } else if ( MapplsPlaceWidgetSetting.instance.pod.equals(AutoSuggestCriteria.POD_STATE, ignoreCase = true)) {
                mBinding.rgPod.check(mBinding.rbState.getId())
            } else if ( MapplsPlaceWidgetSetting.instance.pod.equals(AutoSuggestCriteria.POD_SUB_DISTRICT, ignoreCase = true)) {
                mBinding.rgPod.check(mBinding.rbSubDistrict.getId())
            } else if ( MapplsPlaceWidgetSetting.instance.pod.equals(AutoSuggestCriteria.POD_SUB_LOCALITY, ignoreCase = true)) {
                mBinding.rgPod.check(mBinding.rbSubLocality.getId())
            } else if ( MapplsPlaceWidgetSetting.instance.pod.equals(AutoSuggestCriteria.POD_SUB_SUB_LOCALITY, ignoreCase = true)) {
                mBinding.rgPod.check(mBinding.rbSubSubLocality.getId())
            } else if ( MapplsPlaceWidgetSetting.instance.pod.equals(AutoSuggestCriteria.POD_VILLAGE, ignoreCase = true)) {
