...
public class CameraFeatureFragment extends Fragment {
        ...
        mapFeatureListAdapter.setOnClickListener(new MapFeatureListAdapter.OnClickListener() {
            ...
            public void onClick(int position) {
                if (position == 0) {
                    ...
                    Intent mapClickIntent = new Intent(getContext(), MapplsPinCameraActivity.class);
                    startActivity(mapClickIntent);
                }
    ...
    private void setList() {
        ...
        featuresArrayList.add(new FeaturesList("Camera Features in Mappls Pin", "Animate, Move or Ease Camera Position using mappls pin"));
