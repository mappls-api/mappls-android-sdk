...
import com.mappls.sdk.demo.databinding.ActivityLocationCameraOptionsBinding
...
class LocationCameraActivity : AppCompatActivity(), OnMapReadyCallback, LocationEngineCallback<LocationEngineResult>, OnCameraTrackingChangedListener {
    ...
    override fun onSuccess(p0: LocationEngineResult?) {
        if(p0 != null) {
            ...
            mapplsMap?.animateCamera(CameraUpdateFactory.newLatLngZoom(LatLng(location!!.latitude, location.longitude), 16.0))
        }
    }
