...
import com.mappls.sdk.demo.java.plugin.HeatMapPlugin;
...
public class HeatMapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(MapplsMap mapplsMap) {
        ...
        HeatMapPlugin heatMapPlugin = HeatMapPlugin.builder(mapplsMap, mapView)
                .addAll(heatMapOptionList)
                .build();
        heatMapPlugin.addHeatMap();
        mapplsMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(28, 77), 4));
    }
