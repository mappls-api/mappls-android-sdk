...
class HeatMapPlugin private constructor(private val mapplsMap: MapplsMap, mapView: MapView, private val builder: Builder) : MapView.OnDidFinishLoadingStyleListener {
...
// Transition from heatmap to circle layer by zoom level
    ...
    companion object {
        ...
        fun builder(mapplsMap: MapplsMap, mapView: MapView): Builder {
            return Builder(mapplsMap, mapView)
                    .maxZoom(9.0f)
        }


    }
    class Builder internal constructor(private val mapplsMap: MapplsMap, private val mapView: MapView) {
        ...
        fun build() = HeatMapPlugin(mapplsMap, mapView, this)
    }
