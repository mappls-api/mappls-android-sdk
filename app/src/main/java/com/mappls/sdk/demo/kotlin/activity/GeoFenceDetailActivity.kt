...
import com.mappls.sdk.demo.kotlin.adapter.GeoFenceDetailAdapter
...
import com.mappls.sdk.plugin.annotation.*
...
class GeoFenceDetailActivity: AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun setBounds(latLngBound: List<LatLng>) {
        ...
        if (latLngBound.size == 1) {
            ...
            mapplsMap?.animateCamera(CameraUpdateFactory.newLatLngBounds(LatLngBounds.Builder()
