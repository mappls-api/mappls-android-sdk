...
class CardModeActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding.cardFragmentHeader.headerTitle.text = "Card Mode Activity"
        ...
        mBinding.tvSearch.setOnClickListener {
            val builder = PlaceOptions.builder()
                .isShowCurrentLocation(AutoCompleteWidgetSetting.instance.userAddedLocationEnable)
...
// Conditionally add nullable properties
            ...
            builder.build(PlaceOptions.MODE_CARDS)
