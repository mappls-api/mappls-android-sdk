...
public final class MapplsDrivingRangeSetting {

    private static final MapplsDrivingRangeSetting OUR_INSTANCE = new MapplsDrivingRangeSetting();
    ...
    private MapplsDrivingRangeSetting(){}
    ...
    public static MapplsDrivingRangeSetting getInstance() {
        return OUR_INSTANCE;
    }
