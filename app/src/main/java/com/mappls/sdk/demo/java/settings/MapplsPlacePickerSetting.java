...
public class MapplsPlacePickerSetting {

    private static final MapplsPlacePickerSetting OUR_INSTANCE = new MapplsPlacePickerSetting();

    public static MapplsPlacePickerSetting getInstance(){
        return OUR_INSTANCE;
    }
