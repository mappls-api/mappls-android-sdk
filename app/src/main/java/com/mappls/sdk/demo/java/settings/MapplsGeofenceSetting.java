...
public class MapplsGeofenceSetting {

    private static final MapplsGeofenceSetting INSTANCE= new MapplsGeofenceSetting();

    public static MapplsGeofenceSetting getInstance(){
        return INSTANCE;
    }
