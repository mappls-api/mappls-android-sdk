    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding.placePicker.setOnClickListener {
            ...
            val options = PlaceOptions.builder()
                .zoom(MapplsPlacePickerSettings.instance.zoom)
...
//                    .buildingFootprintsEnabled(MapplsPlacePickerSettings.instance.enableFootPrint)
//                    .buildingAppearanceFillColor(MapplsPlacePickerSettings.instance.footprintFillColor)
//                    .buildingAppearanceFillOpacity(MapplsPlacePickerSettings.instance.footprintFillOpacity)
//                    .buildingAppearanceStrokeOpacity(MapplsPlacePickerSettings.instance.footprintLineStrokeOpacity)
//                    .buildingAppearanceStrokeWidth(MapplsPlacePickerSettings.instance.footprintLineStrokeWidth)
//                    .buildingAppearanceStrokeColor(MapplsPlacePickerSettings.instance.footprintStrokeColor)
//                    .entryCoordinateCircleColor(MapplsPlacePickerSettings.instance.entryCoordinateCircleColor)
//                    .entryCoordinateSnapEnable(MapplsPlacePickerSettings.instance.entryCoordinateSnapEnable)
//                    .entryCoordinateSnappingRadius(MapplsPlacePickerSettings.instance.entryCoordinateSnappingRadius)
//                    .showEntryCoordinate(MapplsPlacePickerSettings.instance.showEntryCoordinate)
//                    .entryCoordinateCircleRadius(MapplsPlacePickerSettings.instance.entryCoordinateCircleRadius)
                    .build()
            )
