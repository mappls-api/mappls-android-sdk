...
class GradientPolylineActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding.baseMapHeader.headerTitle.text = getString(R.string.gradient_polyline_title)
    ...
    override fun onMapReady(mapplsMap: MapplsMap) {
        ...
        mapplsMap.getStyle {
            if (it.isFullyLoaded) {
                val gradientPolylinePlugin = GradientPolylinePlugin(mapplsMap, mBinding.mapView)
                gradientPolylinePlugin.createPolyline(listOfLatlang)
