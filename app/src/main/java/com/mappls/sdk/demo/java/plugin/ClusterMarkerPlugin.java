...
import static com.mappls.sdk.maps.style.expressions.Expression.all;
import static com.mappls.sdk.maps.style.expressions.Expression.get;
import static com.mappls.sdk.maps.style.expressions.Expression.gte;
import static com.mappls.sdk.maps.style.expressions.Expression.has;
import static com.mappls.sdk.maps.style.expressions.Expression.literal;
import static com.mappls.sdk.maps.style.expressions.Expression.lt;
import static com.mappls.sdk.maps.style.expressions.Expression.toNumber;
import static com.mappls.sdk.maps.style.layers.PropertyFactory.circleColor;
import static com.mappls.sdk.maps.style.layers.PropertyFactory.circleRadius;
import static com.mappls.sdk.maps.style.layers.PropertyFactory.textAllowOverlap;
import static com.mappls.sdk.maps.style.layers.PropertyFactory.textColor;
import static com.mappls.sdk.maps.style.layers.PropertyFactory.textField;
import static com.mappls.sdk.maps.style.layers.PropertyFactory.textIgnorePlacement;
import static com.mappls.sdk.maps.style.layers.PropertyFactory.textSize;
...
public class ClusterMarkerPlugin implements MapView.OnDidFinishLoadingStyleListener, MapplsMap.OnMapClickListener {
    ...
    public ClusterMarkerPlugin(MapView mapView, MapplsMap mapplsMap) {
...
// Add a filter to the cluster layer that hides the circles based on "point_count"
    ...
    public boolean onMapClick(@NonNull LatLng latLng) {
        ...
        List<Feature> features = mapplsMap.queryRenderedFeatures(this.mapplsMap.getProjection().toScreenLocation(latLng), CLUSTER_CIRCLE_LAYER + 0, CLUSTER_CIRCLE_LAYER + 1, CLUSTER_CIRCLE_LAYER + 2);
        if(features.size() > 0) {
        ...
        if (featureCollectionToInspect.features() != null) {
            ...
            if (latLngList.size() > 1) {
                LatLngBounds latLngBounds = new LatLngBounds.Builder()
                        .includes(latLngList)
                        .build();
                mapplsMap.animateCamera(CameraUpdateFactory.newLatLngBounds(latLngBounds, 20, 20, 20, 20));
            }
        }
    }
}
