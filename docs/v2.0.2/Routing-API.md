...
MapplsDistanceMatrixManager.newInstance(distanceMatrix).call(object : OnResponseCallback<DistanceResponse> {  
   ...
   override fun onError(code: Int, message: String) {  
      //handle Error    
              ...
              //OR
              //To call in Background Thread
val response = MapplsDistanceMatrixManager.newInstance(distanceMatrix).executeCall()
```
#### Java
```java  
...
public void onError(int code, String message) {    
       //Handle Error  
               ...
               //OR
              //To call in Background Thread
ApiResponse<DistanceResponse> response = MapplsDistanceMatrixManager.newInstance(distanceMatrix).executeCall(); 
``` 
### Request Parameter
