...
Why restrict access?
Limiting the geographic scope reduces the volume of data queried and transferred, which helps lower your API transaction costs and improve processing speed.
