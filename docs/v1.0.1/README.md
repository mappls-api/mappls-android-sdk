...
| ---- | ---- |    
| [v1.0.1](../v1.0.1/README.md) | - Map SDK v8.0.4 <br/> - Geo Analytics v1.0.0 <br/> - Place Search Widget v2.0.1 <br/> - GeoFence Widget v1.0.0 <br/> - Scalebar Plugin v1.0.0 <br/> - Direction Widget v1.0.3 <br/> - Nearby UI Widget v1.0.0 <br/> - Annotation Plugin v1.0.0 <br/> - Driving Range Plugin v1.0.0 <br/> - GeoAnalytics Plugin v1.0.0 |
