...
| [v1.0.13](../v1.0.13/README.md) | - Map SDK v8.3.0 <br/> - Geo Analytics v1.0.0 <br/> - Place Search Widget v2.4.0 <br/> - GeoFence Widget v1.0.0 <br/> - Scalebar Plugin v1.0.0 <br/> - Direction Widget v2.3.0 <br/> - Nearby UI Widget v1.0.2 <br/> - Annotation Plugin v1.0.1 <br/> - Driving Range Plugin v1.2.0 <br/> - Raster Catalogue v1.0.0 <br/> - Feedback UI v3.0.1 |
...
For more details of previous documentation versions , [click here](../v1.0.14/Doc-Version-History.md).
...
For more details of previous versions , [click here](../v1.0.14/Version-History.md).
