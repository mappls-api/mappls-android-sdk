...
**v8.0.0 is a major release, to update sdk please follow [reference guide](./Reference-Guide-v7+.md)  to update SDK from v7+ to v8.0.0 and [reference guide](./Reference-Guide.md) to update SDK from v6+ to v8.0.0**
