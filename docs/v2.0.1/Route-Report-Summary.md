...
val response = MapplsRouteSummaryManager.newInstance(mapplsRouteSummary).executeCall()
```
#### Java
```java
...
MapplsRouteSummaryManager.newInstance(mapplsRouteSummary).call(new OnResponseCallback<RouteReportSummaryResponse>() {
    ...
    public void onError(int i, String s) {
        //Handle Failure
  			    ...
  			    //OR
                //To call in Background Thread
ApiResponse<RouteReportSummaryResponse> response = MapplsRouteSummaryManager.newInstance(mapplsRouteSummary).executeCall(); 
```
