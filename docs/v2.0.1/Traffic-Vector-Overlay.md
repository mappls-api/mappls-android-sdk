...
# [Mappls Traffic Overlay]()

Mappls Traffic Vector Tiles is a dynamic overlay that displays real-time traffic conditions directly on the map.
It delivers continuously updating congestion data, offering an accurate and up-to-date view of traffic flow.

This overlay is compatible with all Mappls map styles and is best visualized when used with Mappls Maps for optimal clarity and performance.

Read more for [Map Styles](./Map-Style.md)
