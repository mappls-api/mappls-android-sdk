...
val response = MapplsPredictiveDirectionManager.newInstance(mapplsPredictiveDirections).executeCall() 
```
#### Java
```java  
...
MapplsPredictiveDirectionManager.newInstance(mapplsPredictiveDirections).call(new OnResponseCallback<PredictiveDirectionsResponse>() {
	...
	public void onError(int code, String message) {  
	 //Handle Error      
			...
			//OR
			//To call in background Thread
 ApiResponse<PredictiveDirectionsResponse> response = MapplsPredictiveDirectionManager.newInstance(mapplsPredictiveDirections).executeCall(); 
 ```  
...
MapplsPredictiveDistanceManager.newInstance(mapplsPredictiveDistance).call(object : OnResponseCallback<PredictiveDistanceResponse> {    
   ...
   override fun onError(code: Int, message: String) {    
      //handle Error      
			...
			//OR
			//To call in background Thread
val response = MapplsPredictiveDistanceManager.newInstance(mapplsPredictiveDistance).executeCall() 
```
#### Java
```java
...
MapplsPredictiveDistanceManager.newInstance(mapplsPredictiveDistance).call(new OnResponseCallback<PredictiveDistanceResponse>() {    
    ...
    public void onError(int code, String message) {    
        //Handle Error  
			...
			//OR
			//To call in background Thread
 ApiResponse<PredictiveDistanceResponse> response = MapplsPredictiveDistanceManager.newInstance(mapplsPredictiveDistance).executeCall(); 
```
