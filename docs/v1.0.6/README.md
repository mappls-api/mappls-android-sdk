...
For more details of previous documentation versions , [click here](../v1.0.6/Doc-Version-History.md).
...
For more details of previous versions , [click here](../v1.0.6/Version-History.md).
